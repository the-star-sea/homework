...
void write() {
    matrix1.row=u;matrix1.column=u; matrix2.row=u;matrix2.column=u;
...
void mode1(){
    ...
    cin>>matrix1.column;
    while(cin.fail()){cout<<"please check your type."<<endl<<"retype:";cin>>matrix1.column;}
    cout<<"how many rows?";
    cin>>matrix1.row;
    while(cin.fail()){cout<<"please check your type."<<endl<<"retype:";cin>>matrix1.row;}
    cout<<"the second matrix: "<<endl<<"how many columns?";
    cin>>matrix2.column;
    while(cin.fail()){cout<<"please check your type."<<endl<<"retype:";cin>>matrix2.column;}
    cout<<"how many rows?";
    cin>>matrix2.row;
    while(cin.fail()){cout<<"please check your type."<<endl<<"retype";cin>>matrix2.row;}
    if(matrix1.column!=matrix2.row){cout<<"size donot match";mode1();}
...
cin>>matrix1.data[i];
while(cin.fail()){cout<<"please check your type."<<endl<<"retype from local position:";cin>>matrix1.data[i];}
   }
    cout<<"please input the second matrix column by column: "<<endl;
    for(int i=0;i<matrix2.column*matrix2.row;i++){
        cin>>matrix2.data[i];
       while(cin.fail()){cout<<"please check your type."<<endl<<"retype from local position:";cin>>matrix2.data[i];}
    }
    ...
    for(int i=0;i<matrix1.row;i++){
        for(int j=0;j<matrix2.column;j++){
            for (int k = 0; k <matrix1.column ; k++) {
                ans[j+i*matrix2.column] +=matrix1.data[k+i*matrix1.column]*matrix2.data[k+j*matrix1.column];
